  ...
  const faqItems = [
    {
      ...
      answer: 'You can reset your password by clicking on your profile menu and selecting "Change Password". Follow the instructions to create a new secure password.'
    },
    {
      question: 'How do I add new users to the system?',
      answer: 'Navigate to the Users section in the sidebar, click "Add User", fill in the required information, and assign appropriate roles and permissions.'
    },
    {
      question: 'Can I customize the dashboard layout?',
      answer: 'Yes, you can customize various aspects of the dashboard including the sidebar, theme, and notification preferences in the Settings section.'
    },
    {
      question: 'How do I export data from the system?',
      answer: 'Each section (Users, Products, Posts, Banners) has an export feature. Look for the export button in the respective section\'s toolbar.'
    }
  ]
  ...
  return (
    <div className={layout.container}>
      <div className="space-y-6">
              ...
              <div key={category.title} className={getCardClasses('base')}>
                <div className="p-6">
                  <div className="flex items-start space-x-4">
                    <div className={`flex-shrink-0 w-12 h-12 bg-gradient-to-br ${category.color} rounded-xl flex items-center justify-center`}>
                        ...
                        {category.items.map((item) => (
                          <li key={item}>
                            <button className="flex items-center text-left hover:text-teal-600 transition-colors">
                              ...
                              <span className={cn(getTypographyClasses('small'), 'text-gray-600 hover:text-teal-600')}>
                                {item}
                              </span>
                            </button>
                          </li>
        ...
        <div className={getCardClasses('base')}>
          <div className="p-6">
            <h3 className={cn(getTypographyClasses('h3'), 'mb-6')}>
            ...
            <div className="space-y-4">
              {faqItems.map((faq, index) => (
                <div key={index} className="border border-gray-200 rounded-lg p-4">
                  <h4 className={cn(getTypographyClasses('h4'), 'mb-2')}>
                    {faq.question}
                  </h4>
