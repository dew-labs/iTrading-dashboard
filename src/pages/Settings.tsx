  ...
  const settingsCategories = [
    {
      ...
      itemKeys: ['profileInformation', 'passwordSecurity', 'emailPreferences', 'privacySettings']
    },
    {
      titleKey: 'notifications',
      icon: Bell,
      descriptionKey: 'notificationsDesc',
      itemKeys: ['emailNotifications', 'pushNotifications', 'activityAlerts', 'marketingUpdates']
    },
    {
      titleKey: 'security',
      icon: Shield,
      descriptionKey: 'securityDesc',
      itemKeys: ['twoFactorAuth', 'loginSessions', 'apiKeys', 'securityLogs']
    },
    {
      titleKey: 'system',
      icon: Database,
    ...
    },
    {
      ...
      itemKeys: ['languageRegion', 'dateTimeFormat', 'currencySettings', 'numberFormatting']
    },
    {
      titleKey: 'appearance',
      icon: Palette,
      descriptionKey: 'appearanceDesc',
      itemKeys: ['themeSelection', 'colorScheme', 'layoutPreferences', 'sidebarConfiguration']
    }
  ]
                  ...
                  <div className='flex items-start space-x-4'>
                    ...
                    <div className='flex-1'>
                      <h3 className={cn(getTypographyClasses('h3'), 'mb-2')}>
                        {t(`settings.${category.titleKey}`)}
                      </h3>
                      <p className={cn(getTypographyClasses('description'), 'mb-4')}>
                        {t(`settings.${category.descriptionKey}`)}
                      </p>
            ...
            <div className='grid grid-cols-1 md:grid-cols-3 gap-6'>
              <div className='flex items-center justify-between p-4 bg-gray-50 rounded-lg'>
                <div className='flex items-center space-x-3'>
                  ...
                  <span className={getTypographyClasses('small')}>{t('settings.darkMode')}</span>
                </div>
              ...
              <div className='flex items-center justify-between p-4 bg-gray-50 rounded-lg'>
                <div className='flex items-center space-x-3'>
                  ...
                  <span className={getTypographyClasses('small')}>
                    {tCommon('entities.notifications')}
                  </span>
                </div>
              ...
              <div className='flex items-center justify-between p-4 bg-gray-50 rounded-lg'>
                <div className='flex items-center space-x-3'>
                  ...
                  <span className={getTypographyClasses('small')}>{t('settings.autoSave')}</span>
                </div>
                <button className='relative inline-flex h-6 w-11 items-center rounded-full bg-teal-500 transition-colors focus:outline-none focus:ring-2 focus:ring-teal-500 focus:ring-offset-2'>
                  <span className='translate-x-6 inline-block h-4 w-4 transform rounded-full bg-white transition-transform' />
                </button>
        ...
        <div className={getCardClasses('base')}>
          <div className='p-8 text-center'>
            ...
            <p className={getTypographyClasses('description')}>
              {t('settings.continuouslyAddingOptions')}
            </p>
          </div>
        </div>
      </div>
