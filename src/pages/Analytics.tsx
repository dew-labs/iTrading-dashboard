        ...
        <div className={layout.grid}>
          <div className={userStatsProps.cardClasses}>
            <div className='flex items-center'>
              ...
              <div className='ml-4'>
                <div className={userStatsProps.valueClasses}>
          ...
          <div className={bannerStatsProps.cardClasses}>
            <div className='flex items-center'>
              ...
              <div className='ml-4'>
                <div className={bannerStatsProps.valueClasses}>
                ...
                <div className='flex items-center justify-between p-4 bg-gradient-to-r from-purple-50 to-purple-100 rounded-lg'>
                  <div className='flex items-center space-x-3'>
                    ...
                    <div>
                      ...
                      <p className={cn(getTypographyClasses('h4'), 'text-purple-900')}>68.4%</p>
                    </div>
                  </div>
                  <div className='text-green-500 flex items-center'>
                    <TrendingUp className='w-4 h-4 mr-1' />
              ...
              <div className='space-y-4'>
                <div className='flex items-start space-x-3 p-3 bg-gray-50 rounded-lg'>
                  ...
                  <div className='flex-1'>
                    ...
                    <p className={cn(getTypographyClasses('xs'), 'text-gray-400')}>2 minutes ago</p>
                  </div>
                </div>
                ...
                <div className='flex items-start space-x-3 p-3 bg-gray-50 rounded-lg'>
                  ...
                  <div className='flex-1'>
                    ...
                    <p className={cn(getTypographyClasses('xs'), 'text-gray-400')}>1 hour ago</p>
                  </div>
                </div>
              </div>
            </div>
